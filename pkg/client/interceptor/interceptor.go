...
func (c *interceptor) SetTokenProvider(tokenProvider token.Provider) {
	if c.funcs.SetTokenProvider != nil {
		c.funcs.SetTokenProvider(tokenProvider)
	}
	c.client.SetTokenProvider(tokenProvider)
}
