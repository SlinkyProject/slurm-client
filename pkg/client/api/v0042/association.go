...
type AssocInterface interface {
	...
	GetAssoc(ctx context.Context, key string) (*types.V0042Assoc, error)
...
func (c *SlurmClient) CreateAssoc(ctx context.Context, req any) (string, error) {
	...
	assoc := &types.V0042Assoc{V0042Assoc: r}
...
// every association.
func (c *SlurmClient) GetAssoc(ctx context.Context, key string) (*types.V0042Assoc, error) {
	cluster, account, user, partition := parseAssocKey(key)
