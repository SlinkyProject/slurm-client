...
func (c *SlurmClient) CreateJobInfo(ctx context.Context, req any) (*int32, error) {
	r, ok := req.(api.V0044JobSubmitReq)
	if !ok {
		return nil, errors.New("expected req to be V0044JobSubmitReq")
	}

	body := api.SlurmV0044PostJobSubmitJSONRequestBody(r)
	res, err := c.SlurmV0044PostJobSubmitWithResponse(ctx, body)
	if err != nil {
		return nil, err
	}
...
func (c *SlurmClient) CreateJobInfoAlloc(ctx context.Context, req any) (*int32, error) {
	r, ok := req.(api.V0044JobAllocReq)
	if !ok {
		return nil, errors.New("expected req to be V0044JobAllocReq")
	}

	body := api.SlurmV0044PostJobAllocateJSONRequestBody(r)
	res, err := c.SlurmV0044PostJobAllocateWithResponse(ctx, body)
	if err != nil {
		return nil, err
	}
...
func (c *SlurmClient) DeleteJobInfo(ctx context.Context, jobId string) error {
	...
	res, err := c.SlurmV0044DeleteJobWithResponse(ctx, jobId, params)
	if err != nil {
		return err
	}
...
func (c *SlurmClient) UpdateJobInfo(ctx context.Context, jobId string, req any) error {
	r, ok := req.(api.V0044JobDescMsg)
	if !ok {
		return errors.New("expected req to be V0044JobDescMsg")
	}

	body := api.SlurmV0044PostJobJSONRequestBody(r)
	res, err := c.SlurmV0044PostJobWithResponse(ctx, jobId, body)
	if err != nil {
		return err
	}
...
func (c *SlurmClient) GetJobInfo(ctx context.Context, jobId string) (*types.V0044JobInfo, error) {
	...
	res, err := c.SlurmV0044GetJobWithResponse(ctx, jobId, params)
	if err != nil {
		return nil, err
	}
...
func (c *SlurmClient) ListJobInfo(ctx context.Context) (*types.V0044JobInfoList, error) {
	...
	res, err := c.SlurmV0044GetJobsWithResponse(ctx, params)
	if err != nil {
		return nil, err
	}
	...
	list := &types.V0044JobInfoList{
		Items: make([]types.V0044JobInfo, len(res.JSON200.Jobs)),
	}
