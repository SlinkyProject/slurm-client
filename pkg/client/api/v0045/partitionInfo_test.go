						...
						SlurmV0045GetPartitionWithResponse: func(ctx context.Context, partitionName string, params *api.SlurmV0045GetPartitionParams, reqEditors ...api.RequestEditorFn) (*api.SlurmV0045GetPartitionResponse, error) {
							res := &api.SlurmV0045GetPartitionResponse{
								...
								JSON200: &api.V0045OpenapiPartitionResp{
									Partitions: []api.V0045PartitionInfo{
					...
					WithInterceptorFuncs(interceptor.Funcs{
						SlurmV0045GetPartitionWithResponse: func(ctx context.Context, partitionName string, params *api.SlurmV0045GetPartitionParams, reqEditors ...api.RequestEditorFn) (*api.SlurmV0045GetPartitionResponse, error) {
							res := &api.SlurmV0045GetPartitionResponse{
								...
								JSONDefault: &api.V0045OpenapiPartitionResp{
...
func TestSlurmClient_ListPartitionInfo(t *testing.T) {
	...
	tests := []struct {
		...
		fields  fields
		args    args
		want    *types.V0045PartitionInfoList
		wantErr bool
	}{
		{
			name: "Empty list",
			...
			want: &types.V0045PartitionInfoList{
				Items: make([]types.V0045PartitionInfo, 0),
			},
			wantErr: false,
		},
		{
			...
			want: &types.V0045PartitionInfoList{
				Items: []types.V0045PartitionInfo{
					{V0045PartitionInfo: api.V0045PartitionInfo{Name: ptr.To("partition-0")}},
					{V0045PartitionInfo: api.V0045PartitionInfo{Name: ptr.To("partition-1")}},
					{V0045PartitionInfo: api.V0045PartitionInfo{Name: ptr.To("partition-2")}},
				},
			},
			wantErr: false,
		},
